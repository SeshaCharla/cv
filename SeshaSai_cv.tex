...
\begin{itemize}[noitemsep,nolistsep,leftmargin=0.25in,label={--}]
	...
	\item Promoted to \textbf{Project Manager: Thermal Testing, Human Space Program (HSP)}, and was involved in development of procedures and infrastructure for thermal vacuum and thermal balance testing of the proposed designs of the spacecraft.\\
\end{itemize}
