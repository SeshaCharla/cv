...
\begin{itemize}[noitemsep,nolistsep,leftmargin=0.25in,label={--}]
	...
	\item Improved and standardized the heater design through a web application to streamline PI gain tuning and real-time heater sensor mapping for the technology development program: \textit{Automation of thermal control during satellite tests}.
\end{itemize}
