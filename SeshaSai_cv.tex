...
\begin{itemize}[noitemsep,nolistsep,leftmargin=0.25in,label={--}]
    ...
    \item Promoted to \textbf{Project Manager: Thermal Testing, Human Space Program (HSP)} (Jan. $2019$ to Jul. $2019$), involved in development of procedures and infrastructure for thermal vacuum and thermal balance testing of the proposed designs of the spacecraft.\\
\end{itemize}
